...
# wait-and-notify.sh
# Description: Wait for a site to come back up and send a notification through
#  Pushover and libnotify.
# Usage: Set variables and run ./wait-and-notify.sh
# Requires: bash, ping, curl, notify-send
#
# dev notes:
# whipped this up in a couple minutes after getting tired of manually checking
# for DNS propagation.
#
