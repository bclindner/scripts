...
# validateall.py
# Description: Validate all HTML and CSS files in a given directory, returning
#  any errors in the terminal by line number.
...
# as of the time of this writing, I work as a TA, and when grading HTML/CSS
# student work, we generally ensure they pass an HTML and CSS validator as part
# of the grade.
#
# earlier on I would use the web front-end (same as the students), but they're
# a bit slow and clunky.
#
# eventually I got tired of it, and wrote a script to leverage the HTTP APIs
# they have exposed on the sites (presumably for exactly this kind of
# purpose!).
#
# every time i start a grading run, I alias this script in my terminal, and run
# it whenever i start grading a submission to catch the most blatant errors.
#
# as such, it gets run a hundred times or more during a work week, saving me
# quite a bit of time on each one, while still returning the same errors they
# would see when using the web interface.
